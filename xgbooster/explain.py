...
import numpy as np
import os
from .mxreason import MXReasoner, ClassEnc, SATReasoner
...
class SATExplainer(object):
    ...
    def prepare(self, sample):
        ...
        # Option 2 prepare the corresponding (K-1) SAT oracles via SATReasoner
        self.oracle = SATReasoner(self.formula, self.out_id, solver=self.optns.solver, 
